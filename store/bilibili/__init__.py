...
async def update_bilibili_video(video_item: Dict):
    ...
    save_content_item = {
        ...
        "play_count": str(video_item_stat.get("view", "")),
        "danmaku": str(video_item_stat.get("danmaku", "")),
        "comment": str(video_item_stat.get("reply", "")),
...
async def update_bilibili_video_comment(video_id: str, comment_item: Dict):
    ...
    save_comment_item = {
        ...
        "publish_time": datetime.fromtimestamp(comment_item.get("ctime")).strftime("%Y-%m-%d %H:%M:%S"),
